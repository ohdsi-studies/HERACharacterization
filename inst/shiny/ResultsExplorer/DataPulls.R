loadDataFromDB <- function(connPool, networkSchema = Sys.getenv("heraCharDbSchema")) {
...
getCovariateValue <- function(connPool, networkSchema = Sys.getenv("heraCharDbSchema"), cohortId, databaseList, comparatorCohortId = NULL) {
